...
import static spring.buttowski.diploma.services.DataService.getBurnersAmountByClusterization2;
...
class DiplomaApplicationTests {
    ...
    public void findOptimalWindow() {
        ...
        for (int border = 2; border <= 200; border++) {
            ...
            List<Data> dataList = dataRepository.findDataByTimeBetweenAndBoilerHouse(dateFrom, dateTo, boilerHouse);
